...
const HeroBanner = () => {
  return (
    <div className="relative rounded-2xl overflow-hidden bg-green-50 dark:bg-green-950 mb-12 border border-transparent dark:border-green-900/50">
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-green-50/90 dark:from-green-950/90 to-transparent"></div>
      </div>
